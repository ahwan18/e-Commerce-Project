...
export const LandingPage = () => {
  ...
  return (
    <div ref={container} className="min-h-screen bg-[#FDF8F5] flex flex-col font-sans selection:bg-pink-300 selection:text-pink-900 overflow-x-hidden">
      ...
      <header className="relative bg-[#4F46E5] text-white overflow-hidden rounded-b-[3rem] sm:rounded-b-[5rem] shadow-2xl z-10 mb-16 pt-36 sm:pt-40">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-2 sm:gap-x-4 mb-6 leading-tight drop-shadow-lg">
            <RevealImageListItem 
              text="Play." 
              className="text-5xl sm:text-7xl md:text-8xl py-0 sm:py-0"
              images={[
                { src: "https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?w=200&auto=format&fit=crop&q=60", alt: "Action Figure 1" },
                { src: "https://images.unsplash.com/photo-1558060370-d644479cb6f7?w=200&auto=format&fit=crop&q=60", alt: "Toy cars" }
              ]}
            />
            <RevealImageListItem 
              text="Discover." 
              className="text-5xl sm:text-7xl md:text-8xl py-0 sm:py-0"
              images={[
                { src: "https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=200&auto=format&fit=crop&q=60", alt: "Educational Toy 1" },
                { src: "https://images.unsplash.com/photo-1530092285049-1c42085fd395?w=200&auto=format&fit=crop&q=60", alt: "Kids Exploring" }
              ]}
            />
            <RevealImageListItem 
              text="Grow." 
              className="text-5xl sm:text-7xl md:text-8xl text-yellow-300 py-0 sm:py-0"
              images={[
                { src: "https://images.unsplash.com/photo-1611891487122-207579d67d98?w=200&auto=format&fit=crop&q=60", alt: "Board game" },
                { src: "https://images.unsplash.com/photo-1500995617113-cf789402a22c?w=200&auto=format&fit=crop&q=60", alt: "Wooden blocks" }
              ]}
            />
          </div>
